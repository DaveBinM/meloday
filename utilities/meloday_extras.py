...
# ---------------------------------------------------------------------------
_DESCRIPTIONS = {
    "funk_disco": ["Get down — funk, disco and pure groove.", "Mirrorball-ready funk and disco."],
    "neo_soul": ["Smooth, slow-burning soul.", "Quiet storm — velvet neo-soul."],
    "motown_soul": ["Classic soul that moves you.", "Motown gold and timeless soul."],
    "after_hours_rnb": ["Late-night, lights-low R&B.", "Slow jams for after hours."],
    "acid_jazz": ["Where jazz meets the dancefloor.", "Funky, jazzy, effortlessly cool."],
    "boom_bap": ["Head-nodding 90s boom bap.", "Crates, breaks and bars."],
    "conscious_flow": ["Thoughtful rap with something to say.", "Jazzy, conscious hip-hop."],
    "g_funk": ["Top down, West Coast bounce.", "G-funk whine and laid-back flows."],
    "trap_mode": ["Hi-hats, 808s and menace.", "Hard trap and drill energy."],
    "lofi_beats": ["Dusty beats to relax/study to.", "Lo-fi loops and mellow haze."],
    "house_party": ["Four-on-the-floor, all night.", "Feel-good house grooves."],
    "deep_house": ["Deep, hypnotic, late-night house.", "Sub-bass and 3am grooves."],
    "techno": ["Relentless, hypnotic techno.", "Warehouse pressure, all night."],
    "trance": ["Hands-up, eyes-closed trance.", "Uplifting trance euphoria."],
    "dnb": ["Rolling breaks and deep bass.", "174 — drum & bass rollers."],
    "bass_drop": ["Wobble, weight and the drop.", "Dubstep and heavyweight bass."],
    "uk_garage": ["Skippy 2-step and garage swing.", "UKG — pirate-radio bounce."],
    "synthwave": ["Neon nights and 80s synths.", "Retro-futurist synthwave drive."],
    "industrial": ["Cold, mechanical, relentless.", "Industrial clang and EBM pulse."],
    "vaporwave": ["Hazy, melted retro nostalgia.", "Vaporwave drift and pastel synths."],
    "downtempo": ["Slow, deep electronic drift.", "Downtempo grooves after dark."],
    "hyperpop": ["Maximalist, candy-coloured chaos.", "Hyperpop sugar rush and glitch."],
    "classic_rock": ["Turn it up — classic rock anthems.", "Guitar heroes and stadium riffs."],
    "heavy_riffs": ["Down-tuned riffs and full power.", "Heavy metal, loud and proud."],
    "punk_energy": ["Fast, loud, three chords.", "Punk — no rules, all energy."],
    "garage_grunge": ["Fuzzed-out garage and grunge.", "Raw riffs and flannel energy."],
    "emo_poppunk": ["Heart-on-sleeve, full volume.", "Emo anthems and pop-punk hooks."],
    "britpop_rock": ["Swaggering Britpop singalongs.", "Madchester groove and 90s guitars."],
    "blues_bar": ["Smoky, late-night blues.", "Electric blues and barroom soul."],
    "psych_haze": ["Swirling, reverb-soaked haze.", "Psychedelic and shoegaze drift."],
    "prog_rock": ["Ambitious, sprawling art-rock.", "Prog epics and odd time signatures."],
    "stoner_rock": ["Fuzzed-out, sun-baked riffs.", "Stoner grooves and desert haze."],
    "reggae_dub": ["Easy skank and deep dub.", "Reggae riddims and dub echoes."],
    "afrobeat": ["Polyrhythmic Afrobeat fire.", "Horns, percussion and groove."],
    "latin_heat": ["Salsa, cumbia and reggaetón heat.", "Turn it up — Latin fire."],
    "bossa_samba": ["Sunlit bossa and samba sway.", "Brazilian warmth and swing."],
    "celtic_folk": ["Fiddles, reels and folk fire.", "Celtic and traditional folk."],
    "ska": ["Pick it up — ska and 2-tone.", "Off-beat horns and skank."],
    "bebop": ["Fast, fearless bebop.", "Hard bop fire and virtuosity."],
    "swing_bigband": ["Swing out — big band brass.", "Jump, jive and swing."],
    "smooth_jazz": ["Easy, smooth and unhurried.", "Lounge jazz and cocktail cool."],
    "country_roads": ["Windows down, country roads.", "Modern country and honky-tonk."],
    "outlaw_country": ["Whiskey-soaked outlaw country.", "Alt-country grit and twang."],
    "bluegrass": ["Banjo rolls and fiddle runs.", "High, lonesome bluegrass."],
    "rockabilly_surf": ["Twang, reverb and rockabilly roll.", "Surf's up — retro rock & roll."],
    "cinematic_epic": ["Sweeping, big-screen scores.", "Epic, cinematic orchestral drama."],
    "ambient_drift": ["Weightless ambient and drone.", "Beatless drift and deep calm."],
    "post_rock": ["Slow builds to soaring peaks.", "Instrumental post-rock crescendos."],
    "chiptune": ["Press start — 8-bit anthems.", "Chiptune and video-game gold."],
    "gospel": ["Hands up — gospel joy.", "Soaring choirs and spirit."],
    "glasgow_folk": ["Scottish folk, fireside-warm.", "Glasgow's folk heart."],
    "glasgow_dream": ["Reverb-washed Glasgow dream-pop.", "Hazy, jangling and wistful."],
    "glasgow_indie": ["Twee, jangly Glasgow indie.", "Belle & Sebastian's hometown sound."],
    "glasgow_soul": ["Glasgow's blue-eyed soul.", "Northern soul and funk warmth."],
    "glasgow_postrock": ["Mogwai-loud, slow-burning swells.", "Glasgow post-rock crescendos."],
    "glasgow_anthems": ["Franz Ferdinand-style art-rock swagger.", "Glasgow guitar anthems."],
    "glasgow_synth": ["Chvrches-bright Glasgow synth-pop.", "Neon synths and big hooks."],
    "glasgow_postpunk": ["Postcard-era Glasgow post-punk.", "Wiry, angular and restless."],
    "glasgow_house": ["Optimo-style left-field house.", "Glasgow's dancefloor underground."],
    "glasgow_underground": ["Sub Club pressure — Glasgow techno.", "Subterranean, relentless and deep."],
    "glasgow_bass": ["LuckyMe wonky, maximal bass.", "Hudson Mohawke-style future bass."],
    "glasgow_late": ["After the club — Glasgow downtempo.", "Late, low and hypnotic."],
    "london_dub": ["Notting Hill dub and lovers rock.", "London's reggae soundsystem."],
    "london_soul": ["Brit-soul à la Winehouse and Sade.", "Smoky London soul."],
    "london_jazz": ["The new London jazz wave.", "Ezra Collective broken-beat jazz."],
    "london_triphop": ["Smoky, cinematic trip-hop.", "London after midnight."],
    "london_mod": ["Sharp-dressed 60s London mod.", "The Kinks, The Who and Carnaby cool."],
    "london_britpop": ["Blur-vs-Oasis London Britpop.", "Cigarettes, alcohol and big choruses."],
    "london_indie": ["Libertines-era London indie.", "Skinny jeans and jagged guitars."],
    "london_calling": ["The only band that matters — London punk.", "Clash-era riot energy."],
    "london_garage": ["Pirate-radio London garage.", "Skippy 2-step swing."],
    "london_grime": ["140 bpm — London grime.", "Skepta, Stormzy, square-wave bass."],
    "london_dubstep": ["Croydon weight — London dubstep.", "Half-step pressure and sub-bass."],
    "london_jungle": ["Amen breaks and ragga jungle.", "London's 174 pressure."],
    "melbourne_folk": ["Melbourne's folk songwriters.", "Acoustic warmth, southern skies."],
    "melbourne_dream": ["Hazy Melbourne dream-pop.", "Jangle, reverb and warmth."],
    "melbourne_soul": ["Future-soul à la Hiatus Kaiyote.", "Melbourne's neo-soul groove."],
    "melbourne_sunset": ["Rooftop, golden-hour indie.", "Sun-soaked Melbourne summer."],
    "melbourne_indie": ["Courtney Barnett-style slacker indie.", "Wry, jangly Melbourne guitars."],
    "melbourne_pubrock": ["Beer-soaked Aussie pub rock.", "Cold Chisel singalong energy."],
    "melbourne_hiphop": ["Aussie flows and laid-back beats.", "Melbourne hip-hop."],
    "melbourne_postpunk": ["Birthday Party-dark post-punk.", "Melbourne's gothic underbelly."],
    "melbourne_psych": ["King Gizzard-style psych churn.", "Melbourne's garage-psych engine."],
    "melbourne_garagepunk": ["Amyl & the Sniffers snarl.", "Melbourne garage-punk fury."],
    "melbourne_club": ["Melbourne bounce, peak-time.", "Big-room club energy."],
    "melbourne_techno": ["Warehouse techno, southside.", "Hypnotic Melbourne techno."],
    "on_repeat": [
